          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.slice(0, 6).map((product, index) => (
              <motion.div
                ...
                className="group relative h-[400px] rounded-2xl overflow-hidden cursor-pointer bg-white"
              >
                <img 
                  src={product.image} 
                  alt={product.name} 
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-end overflow-hidden">
                  <h3 className="font-serif text-2xl text-light font-bold mb-0 group-hover:mb-2 transition-all duration-500 ease-out">
                    {product.name}
                  </h3>
